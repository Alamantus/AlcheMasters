...
var app = express();
app.use(express.static('./public/'), le.middleware());
//
...
le.check({ domains: [ 'localssltest.alamantus.com' ] }).then(function (results) {
  if (results) {
  ...
  le.register({
    ...
    domains: ['localssltest.alamantus.com']                                // CHANGE TO YOUR DOMAIN (list for SANS)
  , email: 'gamedev@alamantus.com'                                 // CHANGE TO YOUR EMAIL
